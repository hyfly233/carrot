...
```json
{
    ...
    "configurations": [
        ...
        },
        {
            ...
            "args": [
                "--config",
                "${workspaceFolder}/configs/nodemanager.yaml",
                "--rm-url",
                "http://localhost:8088"
            ],
            "env": {
...
<component name="ProjectRunConfigurationManager">
  <configuration default="false" name="ResourceManager" type="GoApplicationRunConfiguration" factoryName="Go Application">
    <module name="carrot" />
