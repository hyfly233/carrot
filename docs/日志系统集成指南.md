...
```bash
# ResourceManager 日志
kafka-topics.sh --create --topic carrot-rm-logs --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1

# NodeManager 日志  
kafka-topics.sh --create --topic carrot-nm-logs --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1

# ApplicationMaster 日志
kafka-topics.sh --create --topic carrot-am-logs --bootstrap-server localhost:9092 --partitions 3 --replication-factor 1
```
...
kafka-console-consumer.sh --topic carrot-rm-logs --bootstrap-server localhost:9092 --from-beginning

# 消费 NodeManager 日志
kafka-console-consumer.sh --topic carrot-nm-logs --bootstrap-server localhost:9092 --from-beginning

# 消费 ApplicationMaster 日志
kafka-console-consumer.sh --topic carrot-am-logs --bootstrap-server localhost:9092 --from-beginning
```
...
# 查看消费者状态
kafka-consumer-groups.sh --bootstrap-server localhost:9092 --group carrot-log-group --describe
```
