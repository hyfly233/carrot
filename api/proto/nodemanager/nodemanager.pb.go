...
type GetNodeStatusResponse struct {
	...
	HealthStatus      *HealthStatus          `protobuf:"bytes,5,opt,name=health_status,json=healthStatus,proto3" json:"health_status,omitempty"`
	State             NodeState              `protobuf:"varint,6,opt,name=state,proto3,enum=carrot.nodemanager.v1.NodeState" json:"state,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ContainerStatus struct {
	...
	State         ContainerState         `protobuf:"varint,3,opt,name=state,proto3,enum=carrot.nodemanager.v1.ContainerState" json:"state,omitempty"`
...
type ContainerAction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ContainerId   string                 `protobuf:"bytes,1,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	Action        ActionType             `protobuf:"varint,2,opt,name=action,proto3,enum=carrot.nodemanager.v1.ActionType" json:"action,omitempty"`
...
type HealthStatus struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	State            HealthState            `protobuf:"varint,1,opt,name=state,proto3,enum=carrot.nodemanager.v1.HealthState" json:"state,omitempty"`
...
type HealthCheck struct {
	...
	State         HealthState            `protobuf:"varint,2,opt,name=state,proto3,enum=carrot.nodemanager.v1.HealthState" json:"state,omitempty"`
...
const file_api_proto_nodemanager_proto_rawDesc = "" +
	"\n" +
	"\x1bapi/proto/nodemanager.proto\x12\x15carrot.nodemanager.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xcc\x01\n" +
	"\x13RegisterNodeRequest\x12<\n" +
	"\tnode_info\x18\x01 \x01(\v2\x1f.carrot.nodemanager.v1.NodeInfoR\bnodeInfo\x12T\n" +
	"\x10total_capability\x18\x02 \x01(\v2).carrot.nodemanager.v1.ResourceCapabilityR\x0ftotalCapability\x12!\n" +
	...
	"\x0eused_resources\x18\x02 \x01(\v2$.carrot.nodemanager.v1.ResourceUsageR\rusedResources\x12U\n" +
	"\x12container_statuses\x18\x03 \x03(\v2&.carrot.nodemanager.v1.ContainerStatusR\x11containerStatuses\x128\n" +
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12H\n" +
	"\rhealth_status\x18\x05 \x01(\v2#.carrot.nodemanager.v1.HealthStatusR\fhealthStatus\"\xec\x01\n" +
	"\x11HeartbeatResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12S\n" +
	"\x11container_actions\x18\x03 \x03(\v2&.carrot.nodemanager.v1.ContainerActionR\x10containerActions\x12\x1f\n" +
	...
	"\tnode_info\x18\x01 \x01(\v2\x1f.carrot.nodemanager.v1.NodeInfoR\bnodeInfo\x12T\n" +
	"\x10total_capability\x18\x02 \x01(\v2).carrot.nodemanager.v1.ResourceCapabilityR\x0ftotalCapability\x12K\n" +
	"\x0eused_resources\x18\x03 \x01(\v2$.carrot.nodemanager.v1.ResourceUsageR\rusedResources\x12U\n" +
	"\x12container_statuses\x18\x04 \x03(\v2&.carrot.nodemanager.v1.ContainerStatusR\x11containerStatuses\x12H\n" +
	"\rhealth_status\x18\x05 \x01(\v2#.carrot.nodemanager.v1.HealthStatusR\fhealthStatus\x126\n" +
	"\x05state\x18\x06 \x01(\x0e2 .carrot.nodemanager.v1.NodeStateR\x05state\"\xa7\x01\n" +
	"\bNodeInfo\x12\x17\n" +
	...
	"\x12extended_resources\x18\x03 \x03(\v2@.carrot.nodemanager.v1.ResourceCapability.ExtendedResourcesEntryR\x11extendedResources\x1aD\n" +
	...
	"\x12extended_resources\x18\x03 \x03(\v2;.carrot.nodemanager.v1.ResourceUsage.ExtendedResourcesEntryR\x11extendedResources\x12*\n" +
	...
	"\x05state\x18\x03 \x01(\x0e2%.carrot.nodemanager.v1.ContainerStateR\x05state\x12\x1b\n" +
	"\texit_code\x18\x04 \x01(\x05R\bexitCode\x12 \n" +
	"\vdiagnostics\x18\x05 \x01(\tR\vdiagnostics\x12K\n" +
	"\x0eresource_usage\x18\x06 \x01(\v2$.carrot.nodemanager.v1.ResourceUsageR\rresourceUsage\x129\n" +
	"\n" +
	...
	"\x06action\x18\x02 \x01(\x0e2!.carrot.nodemanager.v1.ActionTypeR\x06action\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\"\x89\x02\n" +
	"\fHealthStatus\x128\n" +
	"\x05state\x18\x01 \x01(\x0e2\".carrot.nodemanager.v1.HealthStateR\x05state\x12,\n" +
	...
	"\rhealth_checks\x18\x04 \x03(\v2\".carrot.nodemanager.v1.HealthCheckR\fhealthChecks\"\xaf\x01\n" +
	"\vHealthCheck\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x128\n" +
	"\x05state\x18\x02 \x01(\x0e2\".carrot.nodemanager.v1.HealthStateR\x05state\x12\x18\n" +
	...
	"\fRegisterNode\x12*.carrot.nodemanager.v1.RegisterNodeRequest\x1a+.carrot.nodemanager.v1.RegisterNodeResponse\x12^\n" +
	"\tHeartbeat\x12'.carrot.nodemanager.v1.HeartbeatRequest\x1a(.carrot.nodemanager.v1.HeartbeatResponse\x12j\n" +
	"\rGetNodeStatus\x12+.carrot.nodemanager.v1.GetNodeStatusRequest\x1a,.carrot.nodemanager.v1.GetNodeStatusResponseB\x1eZ\x1ccarrot/api/proto/nodemanagerb\x06proto3"
...
var file_api_proto_nodemanager_proto_goTypes = []any{
	(ContainerState)(0),           // 0: carrot.nodemanager.v1.ContainerState
	(ActionType)(0),               // 1: carrot.nodemanager.v1.ActionType
	(HealthState)(0),              // 2: carrot.nodemanager.v1.HealthState
	(NodeState)(0),                // 3: carrot.nodemanager.v1.NodeState
	(*RegisterNodeRequest)(nil),   // 4: carrot.nodemanager.v1.RegisterNodeRequest
	(*RegisterNodeResponse)(nil),  // 5: carrot.nodemanager.v1.RegisterNodeResponse
	(*HeartbeatRequest)(nil),      // 6: carrot.nodemanager.v1.HeartbeatRequest
	(*HeartbeatResponse)(nil),     // 7: carrot.nodemanager.v1.HeartbeatResponse
	(*GetNodeStatusRequest)(nil),  // 8: carrot.nodemanager.v1.GetNodeStatusRequest
	(*GetNodeStatusResponse)(nil), // 9: carrot.nodemanager.v1.GetNodeStatusResponse
	(*NodeInfo)(nil),              // 10: carrot.nodemanager.v1.NodeInfo
	(*ResourceCapability)(nil),    // 11: carrot.nodemanager.v1.ResourceCapability
	(*ResourceUsage)(nil),         // 12: carrot.nodemanager.v1.ResourceUsage
	(*ContainerStatus)(nil),       // 13: carrot.nodemanager.v1.ContainerStatus
	(*ContainerAction)(nil),       // 14: carrot.nodemanager.v1.ContainerAction
	(*HealthStatus)(nil),          // 15: carrot.nodemanager.v1.HealthStatus
	(*HealthCheck)(nil),           // 16: carrot.nodemanager.v1.HealthCheck
	nil,                           // 17: carrot.nodemanager.v1.ResourceCapability.ExtendedResourcesEntry
	nil,                           // 18: carrot.nodemanager.v1.ResourceUsage.ExtendedResourcesEntry
	(*timestamppb.Timestamp)(nil), // 19: google.protobuf.Timestamp
}
var file_api_proto_nodemanager_proto_depIdxs = []int32{
	10, // 0: carrot.nodemanager.v1.RegisterNodeRequest.node_info:type_name -> carrot.nodemanager.v1.NodeInfo
	11, // 1: carrot.nodemanager.v1.RegisterNodeRequest.total_capability:type_name -> carrot.nodemanager.v1.ResourceCapability
	12, // 2: carrot.nodemanager.v1.HeartbeatRequest.used_resources:type_name -> carrot.nodemanager.v1.ResourceUsage
	13, // 3: carrot.nodemanager.v1.HeartbeatRequest.container_statuses:type_name -> carrot.nodemanager.v1.ContainerStatus
	19, // 4: carrot.nodemanager.v1.HeartbeatRequest.timestamp:type_name -> google.protobuf.Timestamp
	15, // 5: carrot.nodemanager.v1.HeartbeatRequest.health_status:type_name -> carrot.nodemanager.v1.HealthStatus
	14, // 6: carrot.nodemanager.v1.HeartbeatResponse.container_actions:type_name -> carrot.nodemanager.v1.ContainerAction
	10, // 7: carrot.nodemanager.v1.GetNodeStatusResponse.node_info:type_name -> carrot.nodemanager.v1.NodeInfo
	11, // 8: carrot.nodemanager.v1.GetNodeStatusResponse.total_capability:type_name -> carrot.nodemanager.v1.ResourceCapability
	12, // 9: carrot.nodemanager.v1.GetNodeStatusResponse.used_resources:type_name -> carrot.nodemanager.v1.ResourceUsage
	13, // 10: carrot.nodemanager.v1.GetNodeStatusResponse.container_statuses:type_name -> carrot.nodemanager.v1.ContainerStatus
	15, // 11: carrot.nodemanager.v1.GetNodeStatusResponse.health_status:type_name -> carrot.nodemanager.v1.HealthStatus
	3,  // 12: carrot.nodemanager.v1.GetNodeStatusResponse.state:type_name -> carrot.nodemanager.v1.NodeState
	17, // 13: carrot.nodemanager.v1.ResourceCapability.extended_resources:type_name -> carrot.nodemanager.v1.ResourceCapability.ExtendedResourcesEntry
	18, // 14: carrot.nodemanager.v1.ResourceUsage.extended_resources:type_name -> carrot.nodemanager.v1.ResourceUsage.ExtendedResourcesEntry
	0,  // 15: carrot.nodemanager.v1.ContainerStatus.state:type_name -> carrot.nodemanager.v1.ContainerState
	12, // 16: carrot.nodemanager.v1.ContainerStatus.resource_usage:type_name -> carrot.nodemanager.v1.ResourceUsage
	19, // 17: carrot.nodemanager.v1.ContainerStatus.start_time:type_name -> google.protobuf.Timestamp
	19, // 18: carrot.nodemanager.v1.ContainerStatus.finish_time:type_name -> google.protobuf.Timestamp
	1,  // 19: carrot.nodemanager.v1.ContainerAction.action:type_name -> carrot.nodemanager.v1.ActionType
	2,  // 20: carrot.nodemanager.v1.HealthStatus.state:type_name -> carrot.nodemanager.v1.HealthState
	19, // 21: carrot.nodemanager.v1.HealthStatus.last_health_update:type_name -> google.protobuf.Timestamp
	16, // 22: carrot.nodemanager.v1.HealthStatus.health_checks:type_name -> carrot.nodemanager.v1.HealthCheck
	2,  // 23: carrot.nodemanager.v1.HealthCheck.state:type_name -> carrot.nodemanager.v1.HealthState
	19, // 24: carrot.nodemanager.v1.HealthCheck.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 25: carrot.nodemanager.v1.NodeManagerService.RegisterNode:input_type -> carrot.nodemanager.v1.RegisterNodeRequest
	6,  // 26: carrot.nodemanager.v1.NodeManagerService.Heartbeat:input_type -> carrot.nodemanager.v1.HeartbeatRequest
	8,  // 27: carrot.nodemanager.v1.NodeManagerService.GetNodeStatus:input_type -> carrot.nodemanager.v1.GetNodeStatusRequest
	5,  // 28: carrot.nodemanager.v1.NodeManagerService.RegisterNode:output_type -> carrot.nodemanager.v1.RegisterNodeResponse
	7,  // 29: carrot.nodemanager.v1.NodeManagerService.Heartbeat:output_type -> carrot.nodemanager.v1.HeartbeatResponse
	9,  // 30: carrot.nodemanager.v1.NodeManagerService.GetNodeStatus:output_type -> carrot.nodemanager.v1.GetNodeStatusResponse
