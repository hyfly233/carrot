...
func (HealthState) Descriptor() protoreflect.EnumDescriptor {
	return file_nodemanager_proto_enumTypes[2].Descriptor()
}

func (HealthState) Type() protoreflect.EnumType {
	return &file_nodemanager_proto_enumTypes[2]
}
...
func (NodeState) Descriptor() protoreflect.EnumDescriptor {
	return file_nodemanager_proto_enumTypes[3].Descriptor()
}

func (NodeState) Type() protoreflect.EnumType {
	return &file_nodemanager_proto_enumTypes[3]
}
...
type GetNodeStatusResponse struct {
	...
	HealthStatus      *HealthStatus          `protobuf:"bytes,5,opt,name=health_status,json=healthStatus,proto3" json:"health_status,omitempty"`
	State             NodeState              `protobuf:"varint,6,opt,name=state,proto3,enum=carrot.nodemanager.NodeState" json:"state,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type ContainerStatus struct {
	...
	State         ContainerState         `protobuf:"varint,3,opt,name=state,proto3,enum=carrot.nodemanager.ContainerState" json:"state,omitempty"`
...
type ContainerAction struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ContainerId   string                 `protobuf:"bytes,1,opt,name=container_id,json=containerId,proto3" json:"container_id,omitempty"`
	Action        ActionType             `protobuf:"varint,2,opt,name=action,proto3,enum=carrot.nodemanager.ActionType" json:"action,omitempty"`
...
type HealthStatus struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	State            HealthState            `protobuf:"varint,1,opt,name=state,proto3,enum=carrot.nodemanager.HealthState" json:"state,omitempty"`
...
type HealthCheck struct {
	...
	State         HealthState            `protobuf:"varint,2,opt,name=state,proto3,enum=carrot.nodemanager.HealthState" json:"state,omitempty"`
...
const file_nodemanager_proto_rawDesc = "" +
	"\n" +
	"\x11nodemanager.proto\x12\x12carrot.nodemanager\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc6\x01\n" +
	"\x13RegisterNodeRequest\x129\n" +
	"\tnode_info\x18\x01 \x01(\v2\x1c.carrot.nodemanager.NodeInfoR\bnodeInfo\x12Q\n" +
	"\x10total_capability\x18\x02 \x01(\v2&.carrot.nodemanager.ResourceCapabilityR\x0ftotalCapability\x12!\n" +
	...
	"\x16registration_timestamp\x18\x03 \x01(\x03R\x15registrationTimestamp\"\xca\x02\n" +
	"\x10HeartbeatRequest\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\x12H\n" +
	"\x0eused_resources\x18\x02 \x01(\v2!.carrot.nodemanager.ResourceUsageR\rusedResources\x12R\n" +
	"\x12container_statuses\x18\x03 \x03(\v2#.carrot.nodemanager.ContainerStatusR\x11containerStatuses\x128\n" +
	"\ttimestamp\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\ttimestamp\x12E\n" +
	"\rhealth_status\x18\x05 \x01(\v2 .carrot.nodemanager.HealthStatusR\fhealthStatus\"\xe9\x01\n" +
	"\x11HeartbeatResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12P\n" +
	"\x11container_actions\x18\x03 \x03(\v2#.carrot.nodemanager.ContainerActionR\x10containerActions\x12\x1f\n" +
	"\vresponse_id\x18\x04 \x01(\x03R\n" +
	"responseId\x12-\n" +
	"\x12heartbeat_interval\x18\x05 \x01(\x05R\x11heartbeatInterval\"/\n" +
	"\x14GetNodeStatusRequest\x12\x17\n" +
	"\anode_id\x18\x01 \x01(\tR\x06nodeId\"\xbf\x03\n" +
	"\x15GetNodeStatusResponse\x129\n" +
	"\tnode_info\x18\x01 \x01(\v2\x1c.carrot.nodemanager.NodeInfoR\bnodeInfo\x12Q\n" +
	"\x10total_capability\x18\x02 \x01(\v2&.carrot.nodemanager.ResourceCapabilityR\x0ftotalCapability\x12H\n" +
	"\x0eused_resources\x18\x03 \x01(\v2!.carrot.nodemanager.ResourceUsageR\rusedResources\x12R\n" +
	"\x12container_statuses\x18\x04 \x03(\v2#.carrot.nodemanager.ContainerStatusR\x11containerStatuses\x12E\n" +
	"\rhealth_status\x18\x05 \x01(\v2 .carrot.nodemanager.HealthStatusR\fhealthStatus\x123\n" +
	"\x05state\x18\x06 \x01(\x0e2\x1d.carrot.nodemanager.NodeStateR\x05state\"\xa7\x01\n" +
	"\bNodeInfo\x12\x17\n" +
	...
	"\x06labels\x18\x06 \x03(\tR\x06labels\"\xfd\x01\n" +
	"\x12ResourceCapability\x12\x1b\n" +
	"\tmemory_mb\x18\x01 \x01(\x03R\bmemoryMb\x12\x16\n" +
	"\x06vcores\x18\x02 \x01(\x05R\x06vcores\x12l\n" +
	"\x12extended_resources\x18\x03 \x03(\v2=.carrot.nodemanager.ResourceCapability.ExtendedResourcesEntryR\x11extendedResources\x1aD\n" +
	"\x16ExtendedResourcesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xd1\x02\n" +
	"\rResourceUsage\x12\x1b\n" +
	"\tmemory_mb\x18\x01 \x01(\x03R\bmemoryMb\x12\x16\n" +
	"\x06vcores\x18\x02 \x01(\x05R\x06vcores\x12g\n" +
	"\x12extended_resources\x18\x03 \x03(\v28.carrot.nodemanager.ResourceUsage.ExtendedResourcesEntryR\x11extendedResources\x12*\n" +
	...
	"\x05state\x18\x03 \x01(\x0e2\".carrot.nodemanager.ContainerStateR\x05state\x12\x1b\n" +
	"\texit_code\x18\x04 \x01(\x05R\bexitCode\x12 \n" +
	"\vdiagnostics\x18\x05 \x01(\tR\vdiagnostics\x12H\n" +
	"\x0eresource_usage\x18\x06 \x01(\v2!.carrot.nodemanager.ResourceUsageR\rresourceUsage\x129\n" +
	"\n" +
	...
	"\x06action\x18\x02 \x01(\x0e2\x1e.carrot.nodemanager.ActionTypeR\x06action\x12\x16\n" +
	"\x06reason\x18\x03 \x01(\tR\x06reason\"\x83\x02\n" +
	"\fHealthStatus\x125\n" +
	"\x05state\x18\x01 \x01(\x0e2\x1f.carrot.nodemanager.HealthStateR\x05state\x12,\n" +
	"\x12last_health_report\x18\x02 \x01(\tR\x10lastHealthReport\x12H\n" +
	"\x12last_health_update\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\x10lastHealthUpdate\x12D\n" +
	"\rhealth_checks\x18\x04 \x03(\v2\x1f.carrot.nodemanager.HealthCheckR\fhealthChecks\"\xac\x01\n" +
	"\vHealthCheck\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x125\n" +
	"\x05state\x18\x02 \x01(\x0e2\x1f.carrot.nodemanager.HealthStateR\x05state\x12\x18\n" +
	...
	"\x13NODE_STATE_REBOOTED\x10\a2\xb7\x02\n" +
	"\x12NodeManagerService\x12a\n" +
	"\fRegisterNode\x12'.carrot.nodemanager.RegisterNodeRequest\x1a(.carrot.nodemanager.RegisterNodeResponse\x12X\n" +
	"\tHeartbeat\x12$.carrot.nodemanager.HeartbeatRequest\x1a%.carrot.nodemanager.HeartbeatResponse\x12d\n" +
	"\rGetNodeStatus\x12(.carrot.nodemanager.GetNodeStatusRequest\x1a).carrot.nodemanager.GetNodeStatusResponseB\x1eZ\x1ccarrot/api/proto/nodemanagerb\x06proto3"
...
var file_nodemanager_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_nodemanager_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_nodemanager_proto_goTypes = []any{
	(ContainerState)(0),           // 0: carrot.nodemanager.ContainerState
	(ActionType)(0),               // 1: carrot.nodemanager.ActionType
	(HealthState)(0),              // 2: carrot.nodemanager.HealthState
	(NodeState)(0),                // 3: carrot.nodemanager.NodeState
	(*RegisterNodeRequest)(nil),   // 4: carrot.nodemanager.RegisterNodeRequest
	(*RegisterNodeResponse)(nil),  // 5: carrot.nodemanager.RegisterNodeResponse
	(*HeartbeatRequest)(nil),      // 6: carrot.nodemanager.HeartbeatRequest
	(*HeartbeatResponse)(nil),     // 7: carrot.nodemanager.HeartbeatResponse
	(*GetNodeStatusRequest)(nil),  // 8: carrot.nodemanager.GetNodeStatusRequest
	(*GetNodeStatusResponse)(nil), // 9: carrot.nodemanager.GetNodeStatusResponse
	(*NodeInfo)(nil),              // 10: carrot.nodemanager.NodeInfo
	(*ResourceCapability)(nil),    // 11: carrot.nodemanager.ResourceCapability
	(*ResourceUsage)(nil),         // 12: carrot.nodemanager.ResourceUsage
	(*ContainerStatus)(nil),       // 13: carrot.nodemanager.ContainerStatus
	(*ContainerAction)(nil),       // 14: carrot.nodemanager.ContainerAction
	(*HealthStatus)(nil),          // 15: carrot.nodemanager.HealthStatus
	(*HealthCheck)(nil),           // 16: carrot.nodemanager.HealthCheck
	nil,                           // 17: carrot.nodemanager.ResourceCapability.ExtendedResourcesEntry
	nil,                           // 18: carrot.nodemanager.ResourceUsage.ExtendedResourcesEntry
	(*timestamppb.Timestamp)(nil), // 19: google.protobuf.Timestamp
}
var file_nodemanager_proto_depIdxs = []int32{
	10, // 0: carrot.nodemanager.RegisterNodeRequest.node_info:type_name -> carrot.nodemanager.NodeInfo
	11, // 1: carrot.nodemanager.RegisterNodeRequest.total_capability:type_name -> carrot.nodemanager.ResourceCapability
	12, // 2: carrot.nodemanager.HeartbeatRequest.used_resources:type_name -> carrot.nodemanager.ResourceUsage
	13, // 3: carrot.nodemanager.HeartbeatRequest.container_statuses:type_name -> carrot.nodemanager.ContainerStatus
	19, // 4: carrot.nodemanager.HeartbeatRequest.timestamp:type_name -> google.protobuf.Timestamp
	15, // 5: carrot.nodemanager.HeartbeatRequest.health_status:type_name -> carrot.nodemanager.HealthStatus
	14, // 6: carrot.nodemanager.HeartbeatResponse.container_actions:type_name -> carrot.nodemanager.ContainerAction
	10, // 7: carrot.nodemanager.GetNodeStatusResponse.node_info:type_name -> carrot.nodemanager.NodeInfo
	11, // 8: carrot.nodemanager.GetNodeStatusResponse.total_capability:type_name -> carrot.nodemanager.ResourceCapability
	12, // 9: carrot.nodemanager.GetNodeStatusResponse.used_resources:type_name -> carrot.nodemanager.ResourceUsage
	13, // 10: carrot.nodemanager.GetNodeStatusResponse.container_statuses:type_name -> carrot.nodemanager.ContainerStatus
	15, // 11: carrot.nodemanager.GetNodeStatusResponse.health_status:type_name -> carrot.nodemanager.HealthStatus
	3,  // 12: carrot.nodemanager.GetNodeStatusResponse.state:type_name -> carrot.nodemanager.NodeState
	17, // 13: carrot.nodemanager.ResourceCapability.extended_resources:type_name -> carrot.nodemanager.ResourceCapability.ExtendedResourcesEntry
	18, // 14: carrot.nodemanager.ResourceUsage.extended_resources:type_name -> carrot.nodemanager.ResourceUsage.ExtendedResourcesEntry
	0,  // 15: carrot.nodemanager.ContainerStatus.state:type_name -> carrot.nodemanager.ContainerState
	12, // 16: carrot.nodemanager.ContainerStatus.resource_usage:type_name -> carrot.nodemanager.ResourceUsage
	19, // 17: carrot.nodemanager.ContainerStatus.start_time:type_name -> google.protobuf.Timestamp
	19, // 18: carrot.nodemanager.ContainerStatus.finish_time:type_name -> google.protobuf.Timestamp
	1,  // 19: carrot.nodemanager.ContainerAction.action:type_name -> carrot.nodemanager.ActionType
	2,  // 20: carrot.nodemanager.HealthStatus.state:type_name -> carrot.nodemanager.HealthState
	19, // 21: carrot.nodemanager.HealthStatus.last_health_update:type_name -> google.protobuf.Timestamp
	16, // 22: carrot.nodemanager.HealthStatus.health_checks:type_name -> carrot.nodemanager.HealthCheck
	2,  // 23: carrot.nodemanager.HealthCheck.state:type_name -> carrot.nodemanager.HealthState
	19, // 24: carrot.nodemanager.HealthCheck.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 25: carrot.nodemanager.NodeManagerService.RegisterNode:input_type -> carrot.nodemanager.RegisterNodeRequest
	6,  // 26: carrot.nodemanager.NodeManagerService.Heartbeat:input_type -> carrot.nodemanager.HeartbeatRequest
	8,  // 27: carrot.nodemanager.NodeManagerService.GetNodeStatus:input_type -> carrot.nodemanager.GetNodeStatusRequest
	5,  // 28: carrot.nodemanager.NodeManagerService.RegisterNode:output_type -> carrot.nodemanager.RegisterNodeResponse
	7,  // 29: carrot.nodemanager.NodeManagerService.Heartbeat:output_type -> carrot.nodemanager.HeartbeatResponse
	9,  // 30: carrot.nodemanager.NodeManagerService.GetNodeStatus:output_type -> carrot.nodemanager.GetNodeStatusResponse
